...
Java_com_cambricon_productdisplay_caffenative_CaffeMobile_setNumThreads(JNIEnv *env,
                                                             jobject thiz,
                                                             jint numThreads) {
  LOG(INFO) << "classification setNumThreads";
  int num_threads = numThreads;
  openblas_set_num_threads(num_threads);
}

JNIEXPORT void JNICALL Java_com_cambricon_productdisplay_caffenative_CaffeMobile_enableLog(
    JNIEnv *env, jobject thiz, jboolean enabled) {}

JNIEXPORT jint JNICALL Java_com_cambricon_productdisplay_caffenative_CaffeMobile_loadModel(
    JNIEnv *env, jobject thiz, jstring modelPath, jstring weightsPath) {
  LOG(INFO) << "calssification loadModel";
...
JNIEXPORT void JNICALL
Java_com_cambricon_productdisplay_caffenative_CaffeMobile_setMeanWithMeanFile(
...
JNIEXPORT void JNICALL
Java_com_cambricon_productdisplay_caffenative_CaffeMobile_setMeanWithMeanValues(
...
JNIEXPORT void JNICALL Java_com_cambricon_productdisplay_caffenative_CaffeMobile_setScale(
...
Java_com_cambricon_productdisplay_caffenative_CaffeMobile_getConfidenceScore(
...
Java_com_cambricon_productdisplay_caffenative_CaffeMobile_predictImage(
    JNIEnv *env, jobject thiz, jbyteArray buf, jint width, jint height,
    jint k) {
  CaffeMobile *caffe_mobile = CaffeMobile::Get();
  vector<int> top_k =
...
Java_com_cambricon_productdisplay_caffenative_CaffeMobile_extractFeatures(
    JNIEnv *env, jobject thiz, jbyteArray buf, jint width, jint height,
    jstring blobNames) {
  CaffeMobile *caffe_mobile = CaffeMobile::Get();
